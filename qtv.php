...
<div class="card panel-body text-center">
          ...
          <div class="box box-widget widget-user">
            ...
            <div class="widget-user-header bg-black" style="background: url('http://www.vipvnn.xyz/theme/img/slv.jpg') center center;">
...
<div class="small-box bg-aqua"><h2>ĐẠI LÝ</h2></div>
  <div class="col-md-4 ">
          <div class="box box-widget widget-user">
            <!-- Add the bg color to the header using any of the bg-* classes -->
            <div class="widget-user-header bg-black" style="background: url('http://www.vipvnn.xyz/theme/img/ctv.jpg') center center;">
