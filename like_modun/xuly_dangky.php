                                                               ...
                                                               <tbody>
                                                                  <tr>
                                                                     <td align="center" width="100%" style="padding: 0 15px;text-align: justify;color: rgb(76, 76, 76);font-size: 12px;line-height: 18px;">
                                                                        ...
                                                                        <p style="margin: 20px 0 30px 0;font-size: 15px;text-align: center;">Bạn vừa đăng ký thành công tài khoản <b>'.$username.'</b> tại hệ thống , vui lòng xác mình vào liên kết phía dưới để kích hoạt tài khoản của bạn hoặc nhấn <a href="http://www.vipvnn.xyz/xacminh?code='.$code.'">vào đây để xác minh</a></p>
<div style="font-weight: 200; text-align: center; margin: 25px;"><a href="http://www.vipvnn.xyz/xacminh?code='.$code.'" style="padding:0.6em 1em;border-radius:600px;color:#EEEEEE;font-size:14px;text-decoration:none;font-weight:bold" class="button-color">Xác Minh Ngay</a></div>                          
                                                                     </td>
                                                                  </tr>
                                                               </tbody>
                                                            </table>
